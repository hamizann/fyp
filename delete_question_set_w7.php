...
<nav class="navbar navbar-expand-lg navbar-dark">
    ...
    if (isset($_POST['delete'])) {
        ...
        $deleteAnswersQuery = "DELETE FROM answers_w7 WHERE question_id = $questionId";
        ...
        // Delete the question
        $deleteQuestionQuery = "DELETE FROM questions_w7 WHERE id = $questionId";
        ...
        echo '<meta http-equiv="refresh" content="2;url=edit_w7_quiz.php">';
        exit;
    }
    ?>
