...
<div class="card">
    <div class="card-body">
      ...
      <p><a href="manage_week4.php" class="button">Manage File</a></p>
    </div>
  </div>
  <div class="card">
    <div class="card-body">
      ...
      <p><a href="manage_w4_video.php" class="button">Manage Video</a></p>
    </div>
  </div>
  <div class="card">
    <div class="card-body">
      ...
      <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
      <p><a href="manage_w4_qr.php" class="button">Manage Attendance</a></p>
    </div>
  </div>
</div>
<br>
    <div class="card-group">
        <div class="card">
            ...
            <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
            <p><a href="manage_w4_quiz.php" class="button">Add Quiz</a> <a href="edit_w4_quiz.php" class="button">Edit Quiz</a> <a href="delete_w4_quiz.php" class="button">Delete Quiz</a></p>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
