...
<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div class="container">
            <h1 class="display-4">Week 6 - Course Materials  </h1>
            <p class="lead">This is the course page where you can access each Week 6 study materials.</p>
            <hr class="hr"/>
        </div>
    </div>
    ...
    <div class="container">
    <?php
    $directory = "slides w6/"; // Directory where the files are stored
