...
<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div class="container">
            ...
            <p class="lead">Manage Week 1 study materials.</p>
            <hr class="hr"/>
            <!-- Form to upload slide and video files -->
            <form action="upload_week1_slide.php" method="POST" enctype="multipart/form-data">
                <div class="mb-3">
                    <label for="slide">Slide File:</label>
