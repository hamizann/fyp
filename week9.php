...
<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div class="container">
            <h1 class="display-4">Week 9 - Course Materials  </h1>
            <p class="lead">This is the course page where you can access each Week 9 study materials.</p>
            <hr class="hr"/>
        </div>
    </div>
