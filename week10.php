...
<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div class="container">
            <h1 class="display-4">Week 10 - Course Materials  </h1>
            <p class="lead">This is the course page where you can access each Week 10 study materials.</p>
            <hr class="hr"/>
        </div>
    </div>
    ...
    <div class="container">
    <?php
    $directory = "slides w10/"; // Directory where the files are stored
...
<br>
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            <h1 class="display-4">Week 10 - Quiz  </h1>
            <p class="lead">Complete this quiz to test your understanding of this week's topic.</p>
            <hr class="hr"/>
        </div>
        <div class="col-md-12 text-center">
        <a href="quiz_user_w10.php" class="button">Quiz</a>
        </div>
    </div>
    
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            <h1 class="display-4">Week 10 - Q&A  </h1>
            <p class="lead">Ask any questions related to this week's materials.</p>
            <hr class="hr"/>
        </div>
        <div class="col-md-12 text-center">
        <a href="q&a10_page.php" class="button">Q&A</a>
        <hr class="hr"/>
        </div>
        <div class="container">
            <p class="lead">View the answers for your questions.</p>
            <div class="col-md-12 text-center">
        <a href="view_q&a10_answer.php" class="button">View Answer</a>
        </div>
        </div>
    </div>
    <br><br><br>
