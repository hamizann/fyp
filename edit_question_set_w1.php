...
<div class="container mt-5">
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $updateQuestionQuery = "UPDATE questions SET question_text = '$questionText' WHERE id = $questionId";
            ...
            foreach ($answers as $index => $answer) {
                $answerId = $index + 1;
                $updateAnswerQuery = "UPDATE answers SET answer_text = '$answer' WHERE question_id = $questionId AND id = $answerId";
            ...
            $updateCorrectAnswerQuery = "UPDATE answers SET is_correct = 0 WHERE question_id = $questionId";
            ...
            $updateSelectedAnswerQuery = "UPDATE answers SET is_correct = 1 WHERE question_id = $questionId AND answer_text = '$correctAnswer'";
