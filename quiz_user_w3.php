...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    foreach ($_POST['answers'] as $questionId => $answerId) {
        ...
        $sql = "SELECT is_correct FROM answers_w3 WHERE question_id = ? AND id = ?";
    ...
    $sql = "INSERT INTO user_scores_w3 (user_id, score, timestamp) VALUES (?, ?, ?)";
    $stmt = mysqli_prepare($con, $sql);
    ...
    <div class="container">
        ...
        <form method="POST" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                $sql = "SELECT * FROM answers_w3 WHERE question_id = ?";
                $stmt = mysqli_prepare($con, $sql);
