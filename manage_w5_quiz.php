...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($validSets) {
        ...
        foreach ($questionSets as $setIndex => $questionSet) {
            ...
            $sql = "INSERT INTO questions_w5 (question_text) VALUES ('$questionText')";
            ...
            if ($con->query($sql) === TRUE) {
                ...
                foreach ($answers as $index => $answerText) {
                    ...
                    $sql = "INSERT INTO answers_w5 (question_id, answer_text, is_correct) VALUES ('$questionId', '$answerText', '$isCorrect')";
                    if ($con->query($sql) === TRUE) {
                        // Insert successful
                    } else {
