<?php
    ...
    // Check if the form is submitted to edit an answer
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        $questionId = $_POST['question_id'];
        $newAnswer = $_POST['new_answer'];

        // Update the question with the new answer
        $updateQuery = "UPDATE users_questions SET answer = '$newAnswer' WHERE id = $questionId";
            ...
            <tr>
                ...
                <td>
                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                        ...
                        <textarea name="new_answer" rows="4" cols="30" required></textarea><br>
