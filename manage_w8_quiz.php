...
<nav class="navbar navbar-expand-lg navbar-dark">
    <div class="container px-lg-1">
        <a href="week8_admin.php" class="navbar-brand fs-3 fw-bold"><img src="img\favicon.ico"> FUNDAMENTAL ONLINE GUIDED MODULE TO PERFORM HAJJ AND UMRAH</a>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($validSets) {
        ...
        foreach ($questionSets as $setIndex => $questionSet) {
            ...
            $sql = "INSERT INTO questions_w8 (question_text) VALUES ('$questionText')";
            ...
            if ($con->query($sql) === TRUE) {
                ...
                foreach ($answers as $index => $answerText) {
                    ...
                    $sql = "INSERT INTO answers_w8 (question_id, answer_text, is_correct) VALUES ('$questionId', '$answerText', '$isCorrect')";
                    if ($con->query($sql) === TRUE) {
                        // Insert successful
                    } else {
