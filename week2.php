...
<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div class="container">
            <h1 class="display-4">Week 2 - Course Materials  </h1>
            <p class="lead">This is the course page where you can access each Week 2 study materials.</p>
            <hr class="hr"/>
        </div>
    </div>
    ...
    <div class="container">
    <?php
    $directory = "slides w2/"; // Directory where the files are stored
...
<br>
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            <h1 class="display-4">Week 2 - Quiz  </h1>
            <p class="lead">Complete this quiz to test your understanding of this week's topic.</p>
            <hr class="hr"/>
        </div>
        <div class="col-md-12 text-center">
        <a href="quiz_user_w2.php" class="button">Quiz</a>
        </div>
    </div>
    
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            <h1 class="display-4">Week 2 - Q&A  </h1>
