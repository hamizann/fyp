...
<html>
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            <h1 class="display-4">Manage Week 1 File  </h1>
            <p class="lead">This is the page where you can manage week 1 study materials by upload, edit and delete the file.</p>
            <hr class="hr"/>
    ...
    <div class="row">
        <div class="col-xs-8 col-xs-offset-2">
            <table class="table table-striped table-hover">
                ...
                <tbody>
    <?php 
    $ret = mysqli_query($con, "SELECT * FROM week1_slide");
    $cnt = 1;
    ...
    ?>
        <tr>
            <td><?php echo $cnt; ?></td>
            <td><?php echo $data['week1_slide_title']; ?></td>
            <td><a href="edit.php?id=<?php echo $data['week1_slide_id']; ?>"> <i class="fas fa-edit"></i> Edit</a></td>
            <td><a href="delete.php?id=<?php echo $data['week1_slide_id']; ?>"> <i class="fas fa-trash"></i>Delete</a></td>  
        </tr>
    <?php
        $cnt++;
        }   
